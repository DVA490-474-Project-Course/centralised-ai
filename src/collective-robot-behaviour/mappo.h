...
/*!
 *@brief Resets hidden states and initializes trajectories for agents in a MAPPO
 *implementation.
 ...
 *all agents.
 *@param[in] critic is the created/loaded ctritic network that the MAPPO will be
 *validating from.
...
/*!
 *@brief Algorithm for stepping in the grSim environment and collecting the data
 *needed for training.
 *
 *@details Global constant values is declared in common_types.h!
 * @pre The following preconditions must be met before using this class:
 ...
 *@param[in] critic is the created/loaded ctritic network that the MAPPO will be
 *validating from.
 *@param[in] referee is the automated referee that will be used to get the state
 *of the game.
 *@param[in] vision_client is the vision client that will be used to get/set the
 *state of the game.
 ...
 */
bool CheckModelParametersMatch(const PolicyNetwork& saved_policy,
