 ...
 * Description: Communication header file for public functions for communicating with the ssl interface and simulation interface.
...
{
    /*!
		 * @brief The reward that will be given to the robot when within max_distance_from_center.
		 */
    float average_distance_reward;

    /*!
		 * @brief The maximum distance from the center within the robot will receive the average_distance_reward.
		 */
